...
#eval####
#######
# python3 scripts/generate_eval_jobs.py --batch-grad --num-steps=1024 --num-episodes=200 "./runs/${checkpoint_name}_checkpoints" "./runs/eval_grad/${checkpoint_name}/"
...
python scripts/run_jobs_multiproc.py --num-cpus=64 "./runs/eval_grad/${checkpoint_name}/jobs.sh"
...
#######Graphing######
####################
python3 scripts/generate_plane_jobs.py --grid-size=31 --magnitude=1.0 --num-steps=2000 "./runs/${checkpoint_name}_checkpoints/best/" "./runs/${checkpoint_name}_surface/"
...
python3 scripts/plot_plane.py "./runs/${checkpoint_name}_surface/results.csv" --outname="./runs/${checkpoint_name}_${env_name}_${algo}" --env_name="${env_name}" --type="all"
